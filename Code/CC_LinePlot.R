...
ggplot(PlotData, aes(x=year-.5)) +
    ...
    geom_step(aes(y=median), colour=I('black'), linetype=6, size=1.5) +
    geom_step(aes(y=propcites), colour=I('#D55E00'), size=1.5) +
    geom_step(aes(y=proppapers), colour=I('darkred'), linetype=5, size=1.5) +
...
ggsave(file="../Images/cclineplot.png", width=4, height=2.5)
