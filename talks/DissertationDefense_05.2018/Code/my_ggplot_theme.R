my_theme <- function (base_size = 11, base_family = "") 
{
    ...
    theme(line = element_line(colour = "#f4e6d4", size = 0.5, linetype = 1, lineend = "butt"),
          rect = element_rect(fill = NA, colour = NA, size = 0.5, linetype = 1),
          text = element_text(family = base_family, face = "plain", colour = "#f4e6d4",
                              size = base_size, lineheight = 0.9, hjust = 0.5, vjust = 0.5,
                              angle = 0, margin = margin(), debug = FALSE),
          axis.line = element_blank(),
          axis.line.x = NULL, 
          axis.line.y = NULL,
          axis.text = element_text(size = rel(0.8), colour = "#f4e6d4"),
          ...
          panel.grid.major = element_line(colour = "#f4e6d4", size = 0.5), 
          ...
          strip.text = element_text(colour = "#f4e6d4", size = rel(0.8)),
